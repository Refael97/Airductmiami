---
title: "La puerta de garaje cierra y vuelve a abrir: causas y costos"
description: "La puerta toca el piso y se regresa sola. Los ajustes y sensores detrás de eso, por qué la lluvia y el sol de Florida lo provocan y cuánto cuesta corregirlo."
...
pubDate: 2026-08-27
cluster: symptom
enSlug: garage-door-closes-then-reopens
tags: ["síntoma", "sensores", "motor", "límites de recorrido"]
relatedServices: ["garage-door-opener-repair", "garage-door-tune-up", "garage-door-spring-replacement"]
faq:
  - question: "¿Por qué solo pasa al final de la tarde?"
    answer: "Por dos razones muy de Florida. El sol bajo entrando a un garaje orientado al oeste encandila el ojo eléctrico receptor, y aquí eso pasa todo el año, no en una sola temporada. Además, un garaje que estuvo arriba de 100°F toda la tarde tiene la puerta y el riel asentados un poco distinto que en la mañana fresca, y eso basta para que un límite de bajada muy justo entierre la puerta contra el piso."
  - question: "¿Por qué empezó después de una tormenta?"
    answer: "El agua en el sello inferior es la razón más común. El sello se hincha, o el agua mete arena debajo de él, y la puerta encuentra resistencia una pulgada antes de donde el límite la espera. El agua de tormenta parada junto al cable de los sensores, que corre a ras del piso, también corroe las terminales y hace que los sensores se caigan de forma intermitente."
  - question: "¿Puedo simplemente subirle la fuerza?"
    answer: "Puede, y casi siempre es el arreglo equivocado. Subir la fuerza le ordena al motor empujar más duro contra lo que sea que encuentre, incluida una persona o una mascota. Primero averigüe por qué está encontrando resistencia. Si la puerta se siente pesada a mano, la respuesta es un resorte o una afinación, no una perilla."
  - question: "¿Por qué se regresa antes de llegar al piso?"
    answer: "Un rebote a media bajada es cosa de los sensores de seguridad, no del límite. Algo está cruzando el haz, un sensor quedó fuera de línea o el cable de uno de ellos está fallando. El rebote que ocurre solo después de que la puerta toca el piso es el monitor de fuerza y casi siempre el límite de bajada."
  - question: "¿Es peligrosa una puerta que se regresa cada vez?"
    answer: "El rebote en sí es el sistema de seguridad trabajando. Lo peligroso es el arreglo al que recurre la gente, que es subir la fuerza hasta que la puerta se quede abajo. Y una puerta que pasa el día abierta porque no cierra es un problema de seguridad y, en temporada de tormentas, un problema estructural, así que conviene revisarla en vez de convivir con ella."
---
...
La solución es ajustar el límite de bajada en el motor, una perilla en los equipos viejos o una secuencia de botones en los nuevos. Es una corrección pequeña y va incluida en toda [afinación](/es/servicios/garage-door-tune-up/) que hacemos. Si el problema es el sello, cambiarlo es una refacción barata en la misma visita.
...
![Consola de pared de un motor de puerta de garaje con los botones de bloqueo y de luz. En la mayoría de los equipos, las fallas de sensores y de límites se avisan aquí o con la luz del motor parpadeando.](/images/smart-wall-console.webp)
...
| Ojo eléctrico desalineado o tapado | Una luz de sensor parpadea o está apagada, sol de tarde, insectos | Realineación en una afinación; par de sensores como [reparación de motor](/es/servicios/garage-door-opener-repair/) desde $95 |
...
| Resorte perdiendo tensión | La puerta se cae al soltarla a la altura de la cintura | [Cambio de resortes](/es/servicios/garage-door-spring-replacement/), $150 a $350 por resorte |
| Tarjeta lógica leyendo mal la fuerza | Todo lo anterior salió bien, equipo viejo y muy caliente | Reparación de motor, o un [motor nuevo](/es/servicios/garage-door-opener-installation/) de $275 a $600 si la tarjeta no vale la pena |
