...
export const cities: City[] = [
  ...
  { slug: 'cutler-bay', name: 'Cutler Bay', county: 'Miami-Dade County', region: 'South Florida',
    intro: 'Cutler Bay sits in the path Hurricane Andrew took in 1992, and a great deal of what stands here today was built or rebuilt after it.',
    local: 'That gives the town an unusually clear housing line: post-1992 construction to a tougher code on one side, surviving older homes on the other, and a low coastal position that keeps humidity high in both.',
    nearby: ['homestead', 'pinecrest', 'kendall', 'miami'] },
  ...
  { slug: 'doral', name: 'Doral', county: 'Miami-Dade County', region: 'South Florida',
    intro: 'Doral is one of the newest cities in Miami-Dade and one of the fastest building, which shapes what goes wrong inside its ductwork: construction debris rather than age.',
    local: 'Townhomes and mid-rise condos here are mostly nineties onward, with flexible duct across the attic or a compact air handler in a closet, and a development pace that keeps fine construction dust in the air year round.',
    nearby: ['miami', 'hialeah', 'sweetwater', 'miami-lakes'] },
  { slug: 'sweetwater', name: 'Sweetwater', county: 'Miami-Dade County', region: 'South Florida',
    intro: 'Sweetwater is a small, dense city west of Miami where most of the housing predates modern air conditioning practice and has been added onto since.',
    local: 'Single storey block houses from the sixties and seventies sit beside student rentals near the university, and in both the return path is usually one hallway grille doing more work than it was sized for.',
    nearby: ['miami', 'doral', 'kendall', 'coral-gables'] },
  { slug: 'hialeah-gardens', name: 'Hialeah Gardens', county: 'Miami-Dade County', region: 'South Florida',
    intro: 'Hialeah Gardens is newer than its larger neighbour, so its duct problems are the ones that get built in rather than the ones that come with age.',
    local: 'Eighties through two thousands construction on slab, with flexible duct fanned across attics that pass 120 degrees in July, and warehouse and light industrial blocks that put more dust into the residential air than an inland suburb would carry.',
    nearby: ['hialeah', 'miami-lakes', 'doral', 'miami'] },
  { slug: 'miami-lakes', name: 'Miami Lakes', county: 'Miami-Dade County', region: 'South Florida',
    intro: 'Miami Lakes was planned around its trees and its water, and both of those decide what ends up inside the ductwork here.',
    local: 'A mature canopy drops far more pollen and organic debris than a bare suburb, the lakes hold humidity close to the ground, and the housing runs from sixties ranch homes to recent townhomes, which means three different duct eras in one town.',
    nearby: ['hialeah', 'hialeah-gardens', 'doral', 'miami'] },
  ...
  { slug: 'weston', name: 'Weston', county: 'Broward County', region: 'South Florida',
    intro: 'Weston was built on drained Everglades land in the nineties and two thousands, which makes it one of the newest and most uniform housing stocks we work in.',
    local: 'Two storey homes on slab, frequently on two systems, with flexible duct fanned across attics that reach 120 degrees, and a water table high enough to keep the background humidity up all year.',
    nearby: ['davie', 'pembroke-pines', 'miramar', 'sunrise'] },
  ...
  { slug: 'lake-worth', name: 'Lake Worth Beach', county: 'Palm Beach County', region: 'South Florida',
    intro: 'Lake Worth Beach has some of the oldest housing stock in Palm Beach County, and almost none of it was built with a duct system.',
    local: 'Twenties and thirties cottages and bungalows near the water were designed for cross ventilation, so every duct run in them was added decades later and fitted into a house that was never drawn to carry one.',
    nearby: ['west-palm-beach', 'greenacres', 'boynton-beach', 'delray-beach'] },
  { slug: 'greenacres', name: 'Greenacres', county: 'Palm Beach County', region: 'South Florida',
    intro: 'Greenacres is a working inland suburb of Palm Beach County where most of the housing went up between the seventies and the nineties.',
    local: 'Single storey slab homes and low rise condominiums with attic ducting that has now had thirty or more Florida summers on it, which is exactly when flex starts to sag and joint sealing starts to give.',
    nearby: ['lake-worth', 'west-palm-beach', 'boynton-beach', 'delray-beach'] },
  ...
  { slug: 'town-n-country', name: 'Town \u2019n\u2019 Country', county: 'Hillsborough County', region: 'Tampa Bay',
    intro: 'Town \u2019n\u2019 Country is one of the largest communities in Hillsborough County and one of the oldest suburbs on this side of Tampa.',
    local: 'Sixties and seventies single storey homes on slab, close enough to the bay to take humid air year round, with ductwork that in many houses is still the original layout under newer equipment.',
    nearby: ['tampa', 'clearwater', 'st-petersburg'] },
  ...
  { slug: 'davenport', name: 'Davenport', county: 'Polk County', region: 'Central Florida',
    intro: 'Davenport sits in the vacation home corridor south west of the parks, where a large share of the housing is occupied for only part of the year.',
    local: 'Newer slab construction, much of it short term rental, and a pattern we see nowhere else as strongly: houses shut up for weeks at a time in the wettest months, which is the hardest thing you can do to a Florida air system.',
    nearby: ['poinciana', 'kissimmee', 'lakeland', 'orlando'] },
  { slug: 'poinciana', name: 'Poinciana', county: 'Osceola County', region: 'Central Florida',
    intro: 'Poinciana is one of the largest planned communities in Florida and one of the fastest growing, and its housing is newer than almost anything around it.',
    local: 'Slab construction with flexible duct across the attic, street after street of it, which means the problems here are the ones that get built in rather than the ones that come with age.',
    nearby: ['kissimmee', 'buenaventura-lakes', 'orlando', 'lakeland'] },
  { slug: 'buenaventura-lakes', name: 'Buenaventura Lakes', county: 'Osceola County', region: 'Central Florida',
    intro: 'Buenaventura Lakes is an established Osceola County community where most of the housing dates from the boom of the eighties and nineties.',
    local: 'Single storey slab homes with attic ducting that has now had thirty Florida summers on it, which is exactly the age at which flex duct starts to sag and joint sealing starts to fail.',
    nearby: ['kissimmee', 'poinciana', 'orlando', 'winter-park'] },
  ...
  { slug: 'lehigh-acres', name: 'Lehigh Acres', county: 'Lee County', region: 'Southwest Florida',
    intro: 'Lehigh Acres is one of the largest platted communities in the country, and its housing splits cleanly into two very different eras.',
    local: 'Mid-century lots with modest older homes sit beside whole streets built during the two thousands boom, so a technician here needs to know which decade he is standing in before he says anything about the ductwork.',
    nearby: ['fort-myers', 'cape-coral', 'bonita-springs', 'naples'] },
  { slug: 'immokalee', name: 'Immokalee', county: 'Collier County', region: 'Southwest Florida',
    intro: 'Immokalee is an inland farming community, and the dust load here is unlike anywhere else we serve on the Gulf coast.',
    local: 'Open field on every side, unpaved roads, and a housing mix of older single family homes and manufactured housing, which means both a heavy outdoor dust load and duct systems that were never sealed well to begin with.',
    nearby: ['naples', 'bonita-springs', 'fort-myers', 'lehigh-acres'] },
