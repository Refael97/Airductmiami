...
tags: ["hiring", "buying guide", "florida", "questions"]
featured: false
faq:
  - question: "What is the single most important question to ask?"
    answer: "Ask whether they use source-removal, negative-air equipment. This one question separates real duct cleaning from a superficial 'blow and go' that leaves most of your system dirty."
  - question: "Should the quote be a flat rate or per vent?"
    answer: "Either can be fair, but it must be in writing and clearly state what is included. Per-vent pricing scales with home size; flat rates should specify the number of vents and systems covered."
  - question: "How do I know if an upsell is legitimate?"
    answer: "A legitimate finding — like mold or a damaged duct — should be documented with photos and a written scope of work. High-pressure, same-day-only add-ons are a warning sign."
---
