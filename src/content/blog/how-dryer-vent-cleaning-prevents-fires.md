...
featured: false
faq:
  - question: "Can a clogged dryer vent really start a fire?"
    answer: "Yes. Lint is highly combustible, and when it blocks airflow the dryer's heating element can raise temperatures high enough to ignite the trapped lint inside the vent or cabinet."
  - question: "How does cleaning the vent reduce fire risk?"
    answer: "Cleaning removes the flammable lint fuel and restores airflow, so heat escapes with the exhaust instead of building up inside the dryer and duct."
  - question: "Does a clean lint trap mean my vent is safe?"
    answer: "No. The lint screen only catches part of the lint. The rest travels into the duct and vent, which is where dangerous buildup and most dryer fires occur."
---
...
For most homes, cleaning the dryer vent **at least once a year** keeps buildup from reaching dangerous levels. Households that do frequent laundry, have long vent runs, or own pets should consider more often. Professional cleaning typically runs **$100–$200** — a small price against the cost and danger of a fire.
