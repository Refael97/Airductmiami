---
title: "Dryer Vent Installation in Florida: The 35 Foot Limit"
description: "Correct routing, the materials to use, and the 35 foot equivalent length rule that explains half the blockages we get called out to."
...
tags: ["installation", "routing", "ducting", "florida"]
featured: false
faq:
  - question: "Is a wall vent or a roof vent better for a dryer?"
    answer: "A short exterior wall vent is generally better because it is shorter, has fewer bends, and lets lint exit easily. Roof runs are longer and trap lint faster, though sometimes they are the only option."
  - question: "What is the maximum length for a dryer vent?"
    answer: "A common guideline is a maximum equivalent length of about 35 feet, reduced by roughly 5 feet for each 90-degree elbow. Shorter and straighter is always safer."
  - question: "What duct material should I use in Florida?"
    answer: "Use rigid or semi-rigid metal ducting. Avoid flexible plastic or foil accordion ducts, which trap lint, sag, and can melt or catch fire."
---

How a dryer vent is installed and routed determines how safely and efficiently your dryer runs for years. In Florida, where long roof runs and high humidity are common, getting the routing right matters even more. Here's what to know before installing or replacing a dryer vent.

## Start with the shortest, straightest route

The single most important principle is simple: **shorter and straighter is safer**. Every foot of duct and every elbow adds resistance that slows airflow and gives lint more places to settle. When planning a route, prioritize the exterior wall closest to the dryer.

### Wall vs. roof runs

Many Florida homes route the dryer duct up and out through the roof because of interior layouts. It works, but it comes with trade-offs.
...
## Get the outdoor termination right
...
Florida's climate adds a few considerations:
